...
TEST(HW1Test, MULTIPLY1) {
    Matrix matrix{{1,2,3,4},{1,5,9.3,6},{7,8,8.85,2}};
...
TEST(HW1Test, MULTIPLY2) {
    ...
    EXPECT_TRUE(algebra::multiply(Matrix{}, Matrix{}).empty());
...
TEST(HW1Test, SUM1) {
    ...
    Matrix matrix{{1,2,3,4,5},{7,5.5,6.3,4,2}};
...
TEST(HW1Test, SUM2) {
    ...
    Matrix matrix1{{1,2},{5,5.5},{1,70}};
    Matrix matrix2{{1,2},{5,5.5},{1,70}};
...
TEST(HW1Test, TRANSPOSE) {
    ...
    Matrix matrix{{1,2,3},{1,4,0.3},{1,5,8.85},{7,8,9},{1,0,3.65}};
    Matrix transpose = algebra::transpose(matrix);
    // check the size of the matrix
    EXPECT_EQ(transpose.size(), 3);
    EXPECT_EQ(transpose[0].size(), 5);
    // check the value of the elements
...
TEST(HW1Test, CONCATENATE1) {
    ...
    // test case
    Matrix matrix1{{1,3,4},{5,5,5}};
    Matrix matrix2{{1,3,4},{5,5,5},{1,3,4},{5,5,5}};
...
TEST(HW1Test, CONCATENATE2) {
    ...
    // test case
    Matrix matrix1{{1,3,5},{5.5,6,8.85}};
    Matrix matrix2{{1},{7}};
...
TEST(HW1Test, ERO_SWAP) {
    ...
    // test case
    Matrix matrix{{1,2,3.99},{5.2336,7.89,8.23},{5,0,5.63214},{1,0.36,78}};
